...
public class TaxReturn {
    ...
    /**
     Constructs a TaxReturn objet for a given income and marital status
    ...
    public double getTax() {
        ...
        if (status == SINGLE)
        {
            if (income <= RATE1_SINGLE_LIMIT) tax1 = RATE1 * income;
            else {
            ...
            if (income <= RATE1_MARRIED_LIMIT) tax1 = RATE1 * income;
            else {
